...
static Key keys[] = {
	...
	/*{ MODKEY,			XK_e,		spawn,		SHCMD("st -A 1 -t mail -e neomutt ; pkill -RTMIN+12 dwmblocks; rmdir ~/.abook") }, */
	{ MODKEY,			XK_e,		spawn,		SHCMD("st -A 1 -t mail -e neomutt ; rmdir ~/.abook") }, 
	...
	{ MODKEY|ShiftMask,		XK_n,		spawn,		SHCMD("st -A 1 -t news -e newsboat") },
	...
	//{ 0, XF86XK_Mail,		spawn,		SHCMD("st -A 1 -e neomutt ; pkill -RTMIN+12 dwmblocks") },
